  ...
  template: `
    <aside class="sidebar" [class.mobile-open]="sidebarService.isOpen$ | async">
      ...
      <div class="sidebar-content">
        <nav class="nav-section" *ngIf="currentUser$ | async as user">
          ...
          <a routerLink="/perfil" routerLinkActive="active" class="nav-link" (click)="onLinkClick()">
          ...
          <a *ngIf="hasRole(user, ['ADMIN', 'SUPER_ADMIN'])" routerLink="/personal" routerLinkActive="active" class="nav-link" (click)="onLinkClick()">
            <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
            <span class="nav-text">Gestión de Personal</span>
          </a>
          
          <a *ngIf="hasRole(user, ['ADMIN', 'SUPER_ADMIN', 'JEFE_TERRENO', 'TRABAJADOR_TERRENO', 'TRABAJADOR'])" routerLink="/asistencias" routerLinkActive="active" class="nav-link" (click)="onLinkClick()">
          ...
          <a *ngIf="hasRole(user, ['ADMIN', 'SUPER_ADMIN'])" routerLink="/qr-generator" routerLinkActive="active" class="nav-link" (click)="onLinkClick()">
          ...
          <a *ngIf="hasRole(user, ['ADMIN', 'SUPER_ADMIN'])" routerLink="/comunicados" routerLinkActive="active" class="nav-link" (click)="onLinkClick()">
        ...
        <nav class="nav-section" *ngIf="currentUser$ | async as user">
          <div *ngIf="hasRole(user, ['ADMIN', 'SUPER_ADMIN'])">
...
export class SidebarComponent {
  ...
  hasRole(user: UsuarioResponse | null, allowedRoles: string[]): boolean {
