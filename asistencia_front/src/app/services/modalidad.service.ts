...
export class ModalidadService {
  ...
  listarPaginado(pageRequest: PageRequest): Observable<PaginatedResponse<ModalidadResponse>> {
    return this.http.post<PaginatedResponse<ModalidadResponse>>(`${this.apiUrl}/paged`, pageRequest);
  }
}
